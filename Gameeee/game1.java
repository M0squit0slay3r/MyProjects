...
public class game1 {
    public static void main(String[] args)
    {
        ...
        String random1 = Integer.toString(randomNum);
        String random2 = Integer.toString(randomNum+1);
        String random3 = Integer.toString(randomNum+2);
